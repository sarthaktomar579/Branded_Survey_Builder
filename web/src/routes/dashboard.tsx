          ...
          {surveys.map((survey) => (
            <div key={survey.id} className="card flex justify-between items-center">
              ...
              <div className="flex gap-2">
                <Link to={`/dashboard/survey/${survey.id}`} className="btn btn-secondary">
                  Edit
                </Link>
                <Link to={`/dashboard/survey/${survey.id}/responses`} className="btn btn-secondary">
                  Responses
                </Link>
                <Link to={`/s/${survey.id}`} className="btn btn-primary" target="_blank">
                  Share
                </Link>
              </div>
            </div>
